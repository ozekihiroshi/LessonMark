...
/**
 * Downloads the saved Markdown source of one LessonMark activity.
 *
...
$filename = \mod_lessonmark\local\source_transfer::export_filename($name);
send_temp_file((string) $lessonmark->markdownsource, $filename, true);
