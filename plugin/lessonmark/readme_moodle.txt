...
readable source fallback. All runtime assets and third-party licenses are in
the plugin package. Moodle servers do not need Node.js, a CDN, or an external
rendering service.
